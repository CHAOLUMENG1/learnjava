...
import propertyService.CompneyService;
...
public class Buyer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "契約ID", "ホームID", "物件名", "住所", "類型", "契約対象", "契約日", "価格"
            }
        ));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            bb.setContractId(Integer.parseInt(jTextField4.getText()));
            bb.setPropertyId(Integer.parseInt(jTextField2.getText()));
            bb.setBuyerName(jTextField7.getText());
            bb.setContractDate(jTextField8.getText());
            bb.setPrice(Integer.parseInt(jTextField6.getText()));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
        int row = jTable1.getSelectedRow();
        jTextField4.setText(df.getValueAt(row, 0).toString());
        jTextField2.setText(df.getValueAt(row, 1).toString());
        jTextField7.setText(df.getValueAt(row, 5).toString());
        jTextField8.setText(df.getValueAt(row, 6).toString());
        jTextField6.setText(df.getValueAt(row, 7).toString());
    ...
    public void getlistInfo() {
        BuyerService list = new BuyerService();
        List<JoinBean1> listinfo;

        DefaultTableModel df = (DefaultTableModel) jTable1.getModel();
        df.setRowCount(0);

        listinfo = list.listInfo();
        for (JoinBean1 jc : listinfo) {
            df.addRow(new Object[]{jc.getContractId(), jc.getPropertyId(), jc.getPropertyName(),jc.getAddress(),jc.getPropertyType(),jc.getBuyerName(), jc.getContractDate(), jc.getPrice()});
